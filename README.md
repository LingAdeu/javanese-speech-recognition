...
>[!important]
> I followed standard practices I learned in my Linguistics classes to describe speech sounds and orthographic forms. Square brackets (`[...]` or phonetic bracket) were used to represent phonetic transcriptions based on acoustic properties of a phone (a unit of speech sounds) meanwhile the phonemic slanted slashes (`/.../`) denote abstract mental categories of a phoneme in a specific language, especially Javanese in this case. To explain the transcribed text, I used angle brackets (`<...>` or orthographic brackets) to represent standard written spelling (also called grapheme) in Javanese. While the first-two items represent sounds in concrete and abstract (mental) ways, orthographic transcriptions deal more with spelling conventions.
